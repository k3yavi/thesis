...
\qm is a novel concept but it trades-off speed with accuracy, which shows up in 
...
their genotype and optimize \rapmap for efficient, dynamic (dataset dependent) speed / accurcay 
tradeoff. As \alevin utilizes \rapmap for transcriptome mapping, improved
mapping would be directly reflected on the performance of dscRNA-seq quantification. 
Moreover, we propose a principled approach and study the affect of further extending 
\alevin's UMI deduplication algorithm to include unspliced RNA.
