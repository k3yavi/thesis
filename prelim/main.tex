...
RNA Sequencing technologies are evolving rapidly, and with them, the requirement for fast and 
accurate tools to analyze the generated data. The first step of many sequencing analyses requires 
us to solve the problem of \ra. This study discusses the evolution of the tools
...
The alignment of sequencing reads to a transcriptome is a 
...
We introduce a novel concept, \qm, and an efficient algorithm implementing 
...
\Alevin is written in \texttt{C++14}, and is integrated into the salmon tool
 available at \url{https://github.com/COMBINE-lab/salmon}.
...
The authors would like to thank Fatemeh Almodaresi and Hirak Sarkar for useful discussions during the development of the \alevin method, and would also like to thank Hirak Sarkar for his help in crafting~\Cref{fig:pipeline}. The authors would also like to thank Stony Brook Research Computing and Cyberinfrastructure, and the Institute for Advanced Computational Science at Stony Brook University for access to the high-performance SeaWulf computing system, which was made possible by a $\$1.4$M National Science Foundation grant (\#1531492).
