...
\subsubsection{Selective Alignment}
...
We will focus on one aspect of abundance estimation, namely the
effect of read mapping on the resulting transcript quantification estimates. 
We will explore that the differences in how reads are aligned or mapped can lead to
considerable differences in the predicted abundances.
...
locus in question, allowing it to avoid spurious mappings. We will benchmark this
