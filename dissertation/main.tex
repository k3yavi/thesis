...
\examinerJr{Prof. Joshua \textsc{Rest}} % Your examiner's name, this is not currently used anywhere in the template, print it elsewhere with \examname
...
\large \textit{A Dissertation presented to \\[0.5cm] 
The Graduate School \\[0.5cm] 
in partial fulfillment of the requirements\\[0.5cm] for the degree of \\[0.5cm] 
