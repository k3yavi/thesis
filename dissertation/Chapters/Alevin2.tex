...
We take the quantification estimates from pbmc\_4k experiment with 4340 cells and randomly divide it into
...
approach. In ~\Cref{fig:alv2_t3}, we show the cell wise correlaion of KO 2ka experiment using EM and VBEM
...
signifies cells with informed prior.
  ...
  \begin{figure}[!htb]
      \centering
    \includegraphics[width=\linewidth]{alevin2/migration.png}
